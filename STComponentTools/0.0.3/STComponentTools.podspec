Pod::Spec.new do |spec|
  ...
  spec.homepage         = 'https://github.com/STTechnology5652/STComponentTools'
  spec.license      = { :type => "MIT", :file => "LICENSE" }
  spec.author             = { "stephenchen" => "stephen5652@126.com" }
  spec.ios.deployment_target = '9.0'

  spec.source       = { :git => "https://github.com/STTechnology5652/STComponentTools.git", :tag => "#{spec.version}" }
